...
HANDLE init_serial(char* portName){
    ...
    wchar_t wPortName[10];
    mbstowcs(wPortName, portName, 10);

    HANDLE h_serial = CreateFile(wPortName, GENERIC_READ|GENERIC_WRITE, 0, NULL, OPEN_EXISTING, FILE_FLAG_OVERLAPPED, NULL);
